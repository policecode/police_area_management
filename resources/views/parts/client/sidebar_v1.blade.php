...
<header id="client_sidebar_app" class="header">
        ...
        <div class="container flex items-center justify-between">
            ...
            <div class="header-form xl:flex-1 max-w-[70%] flex items-center justify-between">
                <form action="{{ route('client.search') }}" method="get"
                    ...
                    <div class="auto-complete-result" style="display: block;">
                        <div class="in-loading text-center" style="display: none;">
                        ...
                        <div class="text-result scrollstyle" style="max-height:80vh;overflow:auto;">
                            ...
                            <div class="item-story-search p-2 border-b border-[#d9d9d9] hover:bg-[#f5f5f5]">
                                <a href="truyen/quang-am-chi-ngoai" class="flex" title="Quang Âm Chi Ngoại">
                                    <div class="img w-[60px] relative">
                                        <div class="c-img pt-[140%] rounded-md overflow-hidden">
                                            <picture>
                                                <source media="(min-width:0px)"
                                                    data-srcset="uploads/cover/thumbs/150x0/quang-am-chi-ngoai.jpg"
                                                    srcset="uploads/cover/thumbs/150x0/quang-am-chi-ngoai.jpg">
                                                <img loading="lazy"
                                                    src="uploads/cover/thumbs/150x0/quang-am-chi-ngoai.jpg"
                                                    data-src="uploads/cover/thumbs/150x0/quang-am-chi-ngoai.jpg"
                                                    alt="Quang Âm Chi Ngoại" class="img-fluid">
                                            </picture>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div class="w-full">
                                            <h3 class="text-[0.9375rem] name font-bold text-[#128c7e]"><span
                                                    class="highlight">Quang</span> Âm Chi Ngoại</h3>
                ...
                <ul class="flex items-center user-option">
                    ...
                    <li class="mr-5 last:mr-0 btn-login">
                        <div class="block xl:hidden">
                            <div class="user sm:relative flex show-info-user">
                                <span
                                    class="inline-block overflow-hidden rounded-full avatar w-7 h-7 img_full img-h-full">
                                    <picture>
                                        <source media="(min-width:0px)"
                    ...
                    <li class="mr-5 last:mr-0 menu-mobile block xl:hidden relative">
                        <span class="show-menu-mobile flex">
                        ...
                        <div
                            ...
                            <div class="flex items-center">
                                ...
                                <a href="page/huong-dan.html" title="Hướng dẫn" class="link text-[#128c7e]">Hướng
                                    dẫn</a>
                            </div>
                            ...
                            <ul>
                                ...
                                <li><a href="javascript:void(0)" modal-rs-target="modal_cate" title="Thể loại">Thể
                                        loại</a></li>
                                <li><a href="truyen-hoan-thanh.html" title="Hoàn thành">Hoàn thành</a>
                                </li>
                            </ul>
    ...
    <div class="header-mobile block xl:hidden pb-2 bg-[#f8f9fa]">
        <div class="container flex items-center justify-between">
            ...
            <div class="flex items-center">
                <a href="page/huong-dan.html" title="Hướng dẫn" class="link text-[#128c7e] mr-4 last:mr-0">Hướng
                    dẫn</a>
    ...
    <div class="header-nav bg-[#343a40]">
        <div class="container flex items-center justify-between">
            <div class="flex items-center menu menu-left">
                ...
                <ul>
                    <li><a href="truyen-hoan-thanh.html" title="">Hoàn thành</a></li>
            ...
            <div class="menu menu-right hidden xl:block">
                <ul>
                    <li><a href="page/huong-dan.html" title="Hướng dẫn">Hướng dẫn</a></li>
