...
@section('content')
    ...
    <div id="app">
        ...
        <div class="card shadow mb-4 mt-2">
            ...
            <fvn-paging :page="querySearch.page" :per_page="querySearch.per_page" :total="querySearch.total" @change-limit="changeLimit" @next-page="nextPage(querySearch.page+1)" @back-page="nextPage(querySearch.page-1)"></fvn-paging>
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            addSlot() {
                ...
                this.changeScreen('addSlot');
            },
            async closeAddSlot() {
                this.changeScreen('detail');
                const jsonData = await new RouteApi().get(FVN_PLUGIN_URL + 'ajax.php?task=seatbook.order.detail', { id: this.itemDetail.id })
            ...
            buildQueryItem(task, changeUrl) {
                ...
                if (task == 'export') {
                    ...
                    this.getItemUrl = this.apiUrl + '.index&is_paginate=1';
                } else {
                    this.getItemUrl = this.apiUrl + '.index';
                }
                let paramSearch = {};
