...
<section class="section-cate py-3 min-h-[79vh]">
    <div class="container">
        <div class="flex flex-wrap -mx-2">
            ...
            <a href="{{ $orderTitleLink }}" class="btn-search pb-2 pl-3 text-[#128c7e] text-[1rem]"
            ...
            <a href="{{ $orderLastUpdateLink }}" class="btn-search h-full pb-2 pl-3 text-[#128c7e] text-[1rem]"
                                ...
                                <div class="flex-1 content">
                                    ...
                                    <div class="story-info lg:text-[0.875rem]">
                                        ...
                                        <span class="text-[#007bff] mr-1 whitespace-nowrap">{{ $item['view_count'] }}
                                            Đọc</span>
                                        <span
                                            class="text-[#dc3545] mr-1 whitespace-nowrap">{{ get_string_after_time($item['last_update']) }}</span>
                                    </div>
