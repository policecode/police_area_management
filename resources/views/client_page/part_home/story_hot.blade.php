        ...
        <div class="row">
            <div class="head-title-global d-flex justify-content-between mb-2">
                ...
                <div class="col-4 col-md-3 col-lg-2">
                    <select v-model="querySearch.cat_id" class="form-select select-stories-hot" aria-label="Truyen hot"
                        :disabled="loading">
        ...
        <div class="row">
            <div class="col-12">
                    ...
                    @foreach ($hot_stories as $key => $item)
                        <div class="story-item">
                            <a href="{{ route('client.story', ['story_slug' => $item['slug']]) }}"
                                ...
                                <h3 class="story-item__name text-one-row story-name">{{ ucwords($item['title']) }}</h3>
                ...
                <div v-if="querySearch.cat_id && !loading" class="section-stories-hot__list">
                    <div v-for="item in items" class="story-item">
                        <a :href="item.url" class="d-block text-decoration-none">
                            ...
                            <h3 class="story-item__name text-one-row story-name">@{{ capitalizeFirstLetter(item.title) }}</h3>
                ...
                <div v-if="querySearch.cat_id && loading" class="section-stories-hot__list wrapper-skeleton">
                    <div v-for="item in (new Array(15))" class="skeleton"
