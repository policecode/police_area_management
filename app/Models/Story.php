...
class Story extends Model
{
     ...
     */
    protected $fillable = [
        'user_id', 'title', 'title_eng', 'slug', 'thumbnail', 'description', 'star_count', 'star_average', 'view_count', 'author_id', 'status', 'created_at', 'updated_at', 'last_chapers', 'chaper_id', 'total_chapter', 'total_favorite', 'total_percentage', 'total_report', 'last_comment_id', 'total_like', 'total_comment', 'is_lock', 'propose', 'buy_money', 'buy_position', 'total_money', 'last_chapers', 'listen_count'
    ];
