...
class Tourist extends Model
{
    ...
    public $filterKeywords = ['name', 'slug', 'passport']; // Sử dụng trong trường hợp có trường keyword
    public $filterFields  = ['country']; // SỬ dụng khi tìm kiếm dữ liệu cùng với tên trường trong DB;
